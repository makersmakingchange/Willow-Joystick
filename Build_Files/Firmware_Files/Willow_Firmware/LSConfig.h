...
#define CONF_LIPSYNC_VERSION_MAJOR  0
...
#define CONF_DEBUG_MODE_BUTTON    2
#define CONF_DEBUG_MODE_SWITCH    3
#define CONF_DEBUG_MODE_SAP       4

#define CONF_DEBUG_MODE_MIN 0
#define CONF_DEBUG_MODE_MAX 4
