...
int pollTimerId[CONF_TIMER_MAX+1]; // 6 poll timers
...
void btFeedbackLoop() {
  ...
  if (comMode == CONF_COM_MODE_BLE && tempIsConnected == false && tempIsConnected == btIsConnected) {
    btIsConnected = false;
    pollTimerId[CONF_TIMER_BLUETOOTH] = pollTimer.setTimer(CONF_BT_SCAN_BLINK_DELAY, 0, ((CONF_BT_SCAN_BLINK_NUMBER*2)+1), ledBtScanEffect); 
